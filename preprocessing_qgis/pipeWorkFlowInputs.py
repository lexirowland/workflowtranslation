...
def pipe(tooldescfile = 'rowland_qgis_tooldescriptions.ttl', ontologyfile = 'coreconceptdata.ttl', targetfolder='../preprocessing_qgis'): 
...
#def pipe(tooldescfile = '../../ToolRepository/ToolDescription_TransformationAlgebra.ttl', ontologyfile = 'CoreConceptData.ttl', targetfolder='../testwfalgebra'): 
    ...
    to = os.path.join(targetfolder,name+"_tax"+ext) # to='rowland_qgis_tooldescriptions_tax.ttl'
