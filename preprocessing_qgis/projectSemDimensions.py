...
def main(taxonomy= 'CoreConceptData_tax.ttl',dimnodes=[CCD.CoreConceptQ,CCD.LayerA,CCD.NominalA], targetfolder='../preprocessing_qgis', coretax= 'coreconceptdata_tax_core.ttl'):
