...
def extractToolOntology(tooldesc='rowland_qgis_tooldescription.ttl'):
...
def main(ontologyfile = 'coreconceptdata.ttl', tooldesc='rowland_qgis_tooldescriptions.ttl', to='rowland_qgis_tooldescriptions_tax.ttl',   dto = 'coreconceptdata_tax.ttl'):    
