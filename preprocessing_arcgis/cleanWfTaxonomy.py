...
def extractToolOntology(tooldesc='rowland_arcgis_tooldescription.ttl'):
...
def main(ontologyfile = 'coreconceptdata.ttl', tooldesc='rowland_arcgis_tooldescriptions.ttl', to='rowland_arcgis_tooldescriptions_tax.ttl',   dto = 'coreconceptdata_tax.ttl'):    
